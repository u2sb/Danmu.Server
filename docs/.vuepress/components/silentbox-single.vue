...
<script>
import SilentboxItem from "vue-silentbox/components/item.vue";
import SilentboxOverlay from "vue-silentbox/components/overlay.vue";
import ItemMixin from "vue-silentbox/mixins/item";
export default {
