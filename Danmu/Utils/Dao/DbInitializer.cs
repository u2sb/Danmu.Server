...
namespace Danmu.Utils.Dao
{
    public class DbInitializer
    {
        public static void Initialize(DanmuContext context, AppSettings appSettings)
        {
            ...
            //AidCache表
            context.Database.ExecuteSqlRaw(
                    "CREATE TABLE IF NOT EXISTS \"AidCache\" (\"Id\" int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 MINVALUE 1 MAXVALUE 2147483647 START 1 ),\"Bvid\" TEXT COLLATE \"pg_catalog\".\"default\" NOT NULL, \"Aid\" int4 NOT NULL, \"TimeStamp\" int8 NOT NULL,CONSTRAINT \"PK_AidCache\" PRIMARY KEY ( \"Id\" ) );");

            context.Database.ExecuteSqlRaw(
                    "CREATE INDEX IF NOT EXISTS \"IX_AidCache_Key\" ON \"AidCache\" USING hash ( \"Bvid\" COLLATE \"pg_catalog\".\"default\" \"pg_catalog\".\"text_ops\" );");
